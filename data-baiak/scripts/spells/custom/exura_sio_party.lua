function onCastSpell(creature, var)
    ...
    if party then
        ...
        if membersList == nil then
            creature:sendTextMessage(MESSAGE_STATUS, "N�o h� membros do grupo no alcance com perca de vida.")
            healerPos:sendMagicEffect(CONST_ME_POFF)
            return false
        end
    else
        creature:sendTextMessage(MESSAGE_STATUS, "Voc� n�o est� em um grupo.")
        return false
    end
