local function createSpawnChargingOutburst(stage)
	Game.createMonster("Spark of Destruction", Position(1171, 698, 7), false, true)
	Game.createMonster("Spark of Destruction", Position(1180, 698, 7), false, true)
	Game.createMonster("Spark of Destruction", Position(1172, 703, 7), false, true)
	Game.createMonster("Spark of Destruction", Position(1179, 703, 7), false, true)
	Game.createMonster("Charging Outburst", Position(1176, 700, 7), false, true)
