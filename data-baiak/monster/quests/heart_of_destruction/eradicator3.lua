...
monster.attacks = {
	...
	{name ="big lifedrain wave", interval = 2000, chance = 20, minDamage = -700, maxDamage = -1000, target = false, effect = false},
	{name ="anomaly break", interval = 2000, chance = 40, target = false, effect = false}
}
