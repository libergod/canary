...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -250, radius = 2, shootEffect = CONST_ANI_SMALLEARTH, effect = false, target = false}
}
