SNOWBALL = {
	-- Configura��es de texto
	comandoAtirar = "atirar", -- !snowball atirar
	prefixo = "[SNOWBALL] ",
	mensagemFoiAcertado = "Voc� acabou ser acertado pelo jogador %s e perdeu -%d ponto(s).\nTotal de: %d ponto(s)",
	mensagemAcertei = "Voc� acabou de acertar o jogador %s e ganhou +%d ponto(s).\nTotal de: %d ponto(s)",
	mensagemLider = "Voc� agora � o lider do ranking do SnowBall, parab�ns!",
	mensagemPerdeuLider = "Voc� acaba de perder a primeira coloca��o!",
	mensagemAcabouEvento = "O Evento acabou.",
	mensagemQntBolas = "Ainda restam %d bolas de neve.",
	mensagemNaoTemBola = "Voc� n�o possui bolas de neve.",
	mensagemEventoFaltaPlayer = "O evento foi cancelado por conta de n�o ter no minimo %d jogadores.",
	mensagemInicioEvento = "O evento foi fechado. O jogo come�ou.",
	mensagemEsperandoIniciar = "Faltam %d minuto(s) e %d jogador(es) para o jogo come�ar.",
	mensagemEsperandoIniciar2 = "M�nimo de Players no evento OK! Aguardando %d minuto(s) para o jogo come�ar.",
	mensagemMinutosFaltam = "Faltam %d minuto(s) para o jogo come�ar.",
	mensagemEventoAberto = "O evento foi aberto, v� at� o templo para participar.",
	mensagemComprou = "Voc� acaba de comprar %d bolas de neve por %d\nVoc� tem %d bolas de neve\nVoc� tem %d ponto(s).",
	mensagemFalhaComprar = "Voc� n�o tem %d ponto(s).",
	mensagemMinComprar = "Voc� s� pode comprar bolas de neve com o minimo de 30 bolas.",
	mensagemExausted = "You are exhausted. Wait 1 second to throw another snowball.",
	-- Configura��es de posi��es
	posArena = {{x = 1525, y = 884, z = 7}, {x = 1580, y = 930, z = 7}},
	posEspera = {x = 1553, y = 855, z = 7},
	posTpEntrarEvento = Position(1003, 1217, 7),
	-- Configura��es de muni��o
	muniPreco = 1,
	muniQuant = 100, -- Quantidade de ganho a cada compra.
	muniInicial = 100, -- Come�a com 100
	...
	-- Configura��es de corpos congelados
	corposCongelados = {
	...
	for rank, players in ipairs(CACHE_GAMEPLAYERS) do
		if SNOWBALL.premios[rank] then
			for item_id, item_ammount in pairs(SNOWBALL.premios[rank]) do
				...
				db.query(string.format("INSERT INTO `store_history`(`account_id`, `mode`, `description`, `coin_type`, `coin_amount`, `time`) VALUES (%s, %s, %s, %s, %s, %s)", Player(players):getAccountId(), "0", db.escapeString("[Snowball Event] - Winner"), "1", "300", os.time()))
			end
		end
